            ...
            <Layout>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-12 text-center">
                                    <h1 className="text-display-2">Branding makes your <span className="color-green-900">hiring process </span>Easier</h1>
                                    <p className="text-body-lead-large color-gray-500 mt-40 pr-40">Your brand identity is no longer challenging, and we ensure your brand reaches your talent and customers</p>
                ...
                <section className="section-box overflow-visible mt-70">
                    <div className="container text-center">
                        <h2 className="text-heading-3  color-gray-900 mb-60">Using a Brand power company reduces 60% Hiring Cost </h2>
                        <p className="text-body-lead-large color-gray-500 mt-40 ">The Below Company receives 1000+ Job applications directly on their career page.</p>
                        <br></br><br></br>
                        <div className="row">
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-lg-8 col-sm-10 col-12 text-center mt-40">
                                <h2 className="text-heading-1 color-gray-900 mb-10">Make Your Brand Stand Out</h2>
                                <p className="text-body-lead-large color-gray-600 mt-20">Today’s organization invests in hiring extensively. Spending Half-cost the on branding will allow organizations to grow their competencies, customer, and Hiring.</p>
                            </div>
                            <div className="col-lg-2 col-sm-1 col-12" />
                        </div>
                    </div>
