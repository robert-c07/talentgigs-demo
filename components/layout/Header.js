...
const Header = ({ toggleMenu, headerStyle }) => {
                    ...
                    <div className="main-header">
                        <div className="header-left">
                            <div className="header-logo">
                                <Link href="/">
                                    <a className="d-flex">
                                        {/* {headerStyle ? <img alt="Talentgigs" src="/assets/imgs/template/logo1.png" /> : <img alt="Talentgigs" src="/assets/imgs/template/logo1.png" />} */}
                                        <img width="290px" src="/assets/imgs/template/logo1.png" ></img>
                                    </a>
                                </Link>
                            ...
                            <div className="header-nav">
                                <nav className="nav-main-menu d-none d-xl-block">
                                    <ul className="main-menu">
                                        ...
                                        <li>
                                        <Link href="/campus-hiring"><a>Campus Hiring</a></Link>
                                        </li>
                                ...
                                <div className="burger-icon burger-icon-white  d-lg-none" onClick={toggleMenu}>
                        ...
                        <div className="header-right">
                            <div className="block-signin">
                                <Link href="/contact"><a className="btn btn-default hover-up icon-arrow-right">Get Started</a></Link>
                            </div>
                        </div>
                    </div>
                </div>
